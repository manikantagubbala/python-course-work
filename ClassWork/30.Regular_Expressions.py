...
pattern = re.fullmatch(r'^[A-Z]([a-z])+$',"Manikanta")
...
res = re.search(r'[a-z]*[a-z]$','Hello World')                      # $ --> endswith
print(res.group() if res else "No Pattern")
...
# sub
print("Sub".center(20,"-"))
result = re.sub(r'[aeiouAEIOU]','*',"Python Programming Language")              # Sub is nothing but replace
print(f'Sub : {result}')
